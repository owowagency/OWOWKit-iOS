...
/// For the lack of a better name, instances of `ScrollViewBottomPlaceholderScroller` manages a view that sits
...
public final class ScrollViewBottomPlaceholderScroller<ManagedView: UIView>: NSObject, UIScrollViewDelegate {
